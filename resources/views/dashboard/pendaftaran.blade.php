                ...
                <div class="row">
                    <div class="col-md-12">
                      <!-- pertanyaan -->
                        ...
                        <h5 class="card-title">5. Apakah anda sedang mendapat penyakit jantung berat atau asma dalam keadaan sesak?</h5>
                        <fieldset class="position-relative form-group">
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                            </div>
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                        </fieldset>
                        <h5 class="card-title">6. Apakah anda pernah terkonfirmasi menderita COVID-19 kurang dari 3 bulan?</h5>
                        <fieldset class="position-relative form-group">
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                            </div>
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                        </fieldset>
                        <h3>Pertanyaan Tambahan untuk <strong>Lansia</strong>, Jika terdapat 3 atau lebih jawaban YA maka vaksin tidak dapat diberikan :</h3><br>
                        <h5 class="card-title">7. Apakah Anda mengalami kesulitan untuk naik 10 anak tangga?</h5>
                        <fieldset class="position-relative form-group">
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                            </div>
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                        </fieldset>
                        <h5 class="card-title">8. Apakah Anda sering merasa kelelahan?</h5>
                        <fieldset class="position-relative form-group">
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                            </div>
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                        </fieldset>
                        <h5 class="card-title">9. Apakah Anda memiliki paling sedikit 5 dari 11 penyakit (Hipertensi, diabetes, kanker, penyakit paru kronis,  serangan jantung, gagal jantung kongestif, nyeri dada, asma, nyeri sendi, stroke dan penyakit ginjal)?</h5>
                        <fieldset class="position-relative form-group">
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                            </div>
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                        </fieldset>
                        <h5 class="card-title">10. Apakah Anda mengalami kesulitan berjalan kira-kira 100 sampai 200 meter?</h5>
                        <fieldset class="position-relative form-group">
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                            </div>
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                        </fieldset>
                        <h5 class="card-title">11. Apakah Anda mengalami penurunan berat badan yang bermakna dalam setahun terakhir?</h5>
                        <fieldset class="position-relative form-group">
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                            </div>
                            <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!-- pertanyaan -->
                          ...
                          <h5 class="card-title">7.	Apakah anda sedang mendapat pengobatan immunosupressant seperti kortikosteroid dan kemoterapi?</h5>
                          <fieldset class="position-relative form-group">
                              <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                              </div>
                              <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
                          </fieldset>
                          <h5 class="card-title">8.	Apakah anda pernah terkonfirmasi menderita COVID-19 kurang dari 3 bulan?</h5>
                          <fieldset class="position-relative form-group">
                              <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Ya</label>
                              </div>
                              <div class="position-relative form-check"><label class="form-check-label"><input name="radio1" type="radio" class="form-check-input"> Tidak</label></div>
